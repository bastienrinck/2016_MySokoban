...
** Last update Mon Dec 19 15:39:58 2016 Bastien
*/

#include "sokoban.h"

void	move_up(t_tab *tab, char **tmap, t_player *player, t_game *ginfo)
{
...
void	move_down(t_tab *tab, char **tmap, t_player *player, t_game *ginfo)
{
  if (tmap[player->y + 1][player->x] == '#')
    return ;
  else if (tmap[player->y + 1][player->x] == 'X' && tmap[player->y + 2]
...
void	move_left(t_tab *tab, char **tmap, t_player *player, t_game *ginfo)
{
...
void	move_right(t_tab *tab, char **tmap, t_player *player, t_game *ginfo)
{
  if (tmap[player->y][player->x + 1] == '#')
    return ;
  else if (tmap[player->y][player->x + 1] == 'X' && tmap[player->y]
